...
const CreatePoint = () => {
    ...
    //effect dos itens de coleta
    useEffect(() => {
        api.get('items').then((res: any) => {
            setItems(res.data)
        })
    }, []);
    ...
    function handleSelectUf(event: ChangeEvent<HTMLSelectElement>) {
        const uf : any = event.target.value
    ...
    // function HandleMapClick(onClick: any) {
    //     const [selectedPosition, setSelectedPosition] = useState<[number, number]>([0, 0]);
    ...
    <div id="page-create-point">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <fieldset>
            ...
            <MapContainer center={initialPosition} zoom={5} doubleClickZoom={false} >
                <TileLayer
                    attribution='&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'
                    url="https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png"
                />
                {/* <HandleMapClick onClick={console.log('cliquei')}/> */}
